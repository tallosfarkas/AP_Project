...
## Data Source & Universe Construction
...
## Step 1: Estimating Risk Exposures (Time-Series)
...
## Step 2: Estimating Risk Premia (Cross-Section)
...
## Risk Premia and Pricing Errors
...
3.  **Signal:** We forecast expected excess returns: $$\hat{E}_t[R_{i,t+1}^e] = \hat{\beta}_{i,t}^\top \bar{\lambda}_t$$
